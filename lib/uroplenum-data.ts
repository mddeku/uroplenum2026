...
const programDictionary: Record<string, { en: string; kz: string }> = {
  ...
  "Жюри будет объявлено дополнительно": {
    en: "Jury information will be announced additionally",
    kz: "Қазылар алқасы туралы ақпарат қосымша жарияланады"
  },
...
export const programDetails = [
  ...
  },
  {
    ...
    moderators: ["Жюри будет объявлено дополнительно"],
    talks: [
      ...
      talk("16:20–16:30", text("Мелдеш Сагынбек Ахметалиұлы", "Мелдеш Сагынбек Ахметалиұлы", "Мелдеш Сагынбек Ахметалиұлы"), text("Реконструктивно-пластическая хирургия при 46XX DSD CAH", "Реконструктивно-пластическая хирургия при 46XX DSD CAH", "Реконструктивно-пластическая хирургия при 46XX DSD CAH")),
