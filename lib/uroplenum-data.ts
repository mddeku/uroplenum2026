...
const programDictionary: Record<string, { en: string; kz: string }> = {
  ...
  "Клинический случай г. Атырау": {
    en: "Clinical case from Atyrau",
    kz: "Атыраудан келген клиникалық жағдай"
  },
  ...
  "Гнойно-септические состояния в андрохирургии": {
    en: "Septic-purulent complications in androsurgery",
    kz: "Андрохирургиядағы іріңді-септикалық жағдайлар"
  },
  ...
  "Дуйсенбиенов Ержан Райзаевич": { en: "Yerzhan Duysenbienov", kz: "Дүйсенбиенов Ержан Райзаевич" },
  ...
  "Нургалиев Аслан Асылбекович": { en: "Aslan Nurgaliev", kz: "Нургалиев Аслан Асылбекович" },
  "Асанбек Даулет": { en: "Daulet Asanbek", kz: "Асанбек Даулет" },
  "Абилхасенов Адиль Нурланович": { en: "Abilkhasenov Adil", kz: "Абилхасенов Адиль Нурланович" },
  ...
  "Новые и не стандартные клинические случаи в хирургии опухолей мочевыводящих путей": {
    en: "New and Atypical Clinical Cases in Urinary Tract Tumor Surgery",
    kz: "Урологиялық ісіктер хирургиясындағы тың және сирек кездесетін клиникалық жағдайлар"
  },
...
export const overview: Record<Lang, string[][]> = {
  ...
  kz: [
    ...
    ["14:00-17:30", "Эндоурология секциясы 14:00 – 17:30 / Жас урологтар секциясы 15:10 – 17:30", "«Аспан» залы / «Шанырақ» залы"],
...
export const programDetails = [
  ...
  },
  {
    ...
    talks: [
      ...
      talk("10:15–10:30", text("Ахметов Ернар Ерболатович", "Ахметов Ернар Ерболатович", "Ахметов Ернар Ерболатович"), text("Клинический случай г. Актау", "Клинический случай г. Актау", "Клинический случай г. Актау")),
      talk("10:30–10:45", text("Ирисматов Даврон Розматович", "Ирисматов Даврон Розматович", "Ирисматов Даврон Розматович"), text("Клинический случай г. Атырау", "Клинический случай г. Атырау", "Клинический случай г. Атырау")),
      talk("10:45–11:00", text("Кулмаханов Нурлыбек Бурибаевич", "Кулмаханов Нурлыбек Бурибаевич", "Кулмаханов Нурлыбек Бурибаевич"), text("Клинический случай г. Кызылорда", "Клинический случай г. Кызылорда", "Клинический случай г. Кызылорда")),
      talk("11:00–11:15", text("Умурзаков Хусан Талипбаевич", "Умурзаков Хусан Талипбаевич", "Умурзаков Хусан Талипбаевич"), text("Современные стандарты лечения мКРРПЖ: интеграция данных ASCO, ESMO и EAU в клиническую практику", "Современные стандарты лечения мКРРПЖ: интеграция данных ASCO, ESMO и EAU в клиническую практику", "Современные стандарты лечения мКРРПЖ: интеграция данных ASCO, ESMO и EAU в клиническую практику")),
      talk("11:15–12:00", text("Нургалиев Нуржан Серикович", "Нургалиев Нуржан Серикович", "Нургалиев Нуржан Серикович"), text("PARP ингибирование при мКРРПЖ: данные TALAPRO-2 и актуальные обновления.", "PARP ингибирование при мКРРПЖ: данные TALAPRO-2 и актуальные обновления.", "PARP ингибирование при мКРРПЖ: данные TALAPRO-2 и актуальные обновления.")),
      ...
      talk("12:30–12:45", text("Дуйсенбиенов Ержан Райзаевич", "Дуйсенбиенов Ержан Райзаевич", "Дуйсенбиенов Ержан Райзаевич"), text("Когда начинать PARP ингибитор: сейчас или позже? Новые данные и нерешённые вопросы", "Когда начинать PARP ингибитор: сейчас или позже? Новые данные и нерешённые вопросы", "Когда начинать PARP ингибитор: сейчас или позже? Новые данные и нерешённые вопросы")),
      ...
      talk("13:00–14:00", text("ПЕРЕРЫВ НА ОБЕД", "ПЕРЕРЫВ НА ОБЕД", "ПЕРЕРЫВ НА ОБЕД"), text("ПЕРЕРЫВ НА ОБЕД", "ПЕРЕРЫВ НА ОБЕД", "ПЕРЕРЫВ НА ОБЕД")),
      ...
      talk("14:20–14:30", text("Давранов Анвар Жангирович", "Давранов Анвар Жангирович", "Давранов Анвар Жангирович"), text("Новые и не стандартные клинические случаи в хирургии опухолей мочевыводящих путей", "Новые и не стандартные клинические случаи в хирургии опухолей мочевыводящих путей", "Новые и не стандартные клинические случаи в хирургии опухолей мочевыводящих путей")),
  ...
  },
  {
    ...
    talks: [
      ...
      talk("17:10–17:20", text("Нургалиев Аслан Асылбекович", "Нургалиев Аслан Асылбекович", "Нургалиев Аслан Асылбекович"), text("Ретроградная интраренальная хирургия", "Ретроградная интраренальная хирургия", "Ретроградная интраренальная хирургия")),
  ...
  },
  {
    time: "15:10-17:30",
    room: text("Зал «Шанырак»", "Зал «Шанырак»", "Зал «Шанырак»"),
    title: text("Young Urologists Session", "Секция молодых урологов 15:10 – 17:30", "Жас урологтар секциясы 15:10 – 17:30"),
    ...
    talks: [
      ...
      talk("17:20–17:30", text("Абилхасенов Адиль Нурланович", "Абилхасенов Адиль Нурланович", "Абилхасенов Адиль Нурланович"), text("Гнойно-септические состояния в андрохирургии", "Гнойно-септические состояния в андрохирургии", "Гнойно-септические состояния в андрохирургии"))
    ]
  },
  {
    time: "17:30-18:00",
...
export const faculty = [
  ...
  ...[
    ...
    ["Нургалиев Аслан Асылбекович", "Нұрғалиев Аслан Асылбекұлы"],
